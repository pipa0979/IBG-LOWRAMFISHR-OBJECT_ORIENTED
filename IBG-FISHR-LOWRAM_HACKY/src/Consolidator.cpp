...
void Consolidator::readMatches(std::string path,int pers_count, ErrorCalculator& eCalculator, int trueSNP, float trueCM )
{
...
void Consolidator::performTrim(ErrorCalculator& e_obj,int window,
                               ...
                               float hThreshold, bool holdOut,float empirical_threshold, std::string path, float empirical_pie_threshold)
{
...
void Consolidator::findTrueSimplePctErrors( ErrorCalculator &e_obj, float PIElength, bool holdOut,int window, float ma_threshold, float empirical_ma_threshold, std::string path, int person_count, int trueSNP, float trueCM  )
{
  //begin streaming in bmatch data
  unsigned int pid[2];
  unsigned int sid[2];
...
void Consolidator::findTruePctErrors( ErrorCalculator &e_obj,int ma_snp_ends, bool holdOut,int window,float ma_threshold, float empirical_ma_threshold, std::string path, int person_count, int trueSNP, float trueCM )
{
   //begin streaming in bmatch data
        unsigned int pid[2];
        unsigned int sid[2];
